...
*/
const API_URL = process.env.REACT_APP_API_URL || "https://ml-neurothon-cyberbullying.onrender.com/api";
...
export const analyzeSocialMedia = (data) => {
  return api.post("/analyze-social-media", data);
};
